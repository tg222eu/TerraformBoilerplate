...
**Personal learning project** – Exploring Azure platform foundation / landing zone patterns using Terraform.

### Current Status
This is an early-stage project I started recently to practice Infrastructure as Code concepts.

### What exists so far
- Basic Terraform project structure (providers, variables, outputs)
- Initial configuration for Azure provider
- Planning phased approach for networking, security, logging and storage foundations
